				...
				<div class="form-w3agile form1">
					...
					<form action="./process/register_process.php" method="post">
						...
						<div class="key">
							...
							<input  type="text" value="First Name" name="fname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'First Name';}" required="">
							<div class="clearfix"></div>
						</div>
						<!-- lastname -->
						<div class="key">
							<i class="fa fa-user" aria-hidden="true"></i>
							<input  type="text" value="Last name" name="lname" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Last Name';}" required="">
							<div class="clearfix"></div>
						</div>
						<div class="key">
